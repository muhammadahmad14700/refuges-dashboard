...
function AssignMunicipalityToSupplier(props) {
  ...
  const assignedMunicipalities = useSelector(
    ({ AssignMunicipalityToSupplierReducer }) =>
      AssignMunicipalityToSupplierReducer.AllAssignedMunicipalitiesReducer.data
  );
  const loading = useSelector(
    ({ AssignMunicipalityToSupplierReducer }) =>
      AssignMunicipalityToSupplierReducer.AllAssignedMunicipalitiesReducer.isLoading
  );

  const errMsg = useSelector(
    ({ AssignMunicipalityToSupplierReducer }) =>
      AssignMunicipalityToSupplierReducer.AllAssignedMunicipalitiesReducer.errMsg
  );
  React.useEffect(() => {
    if (sessionStorage.getItem("unAssignedMunicipalities")) {
