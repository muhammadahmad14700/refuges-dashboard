...
function AssignedMentorToMunicipalityMentorsData(props) {
  ...
  const continueClick = () => {
    ...
    history.push({
      pathname: "/editAssignSupplierToMunicipality"
    });
  };
  const cancelClick = () => {
    history.push({
  ...
  return (
    <div>
      ...
      <div style={{ marginTop: "103px" }} className="edit-mun-table-div">
        <InfiniteScroll
          dataLength={props.selectedMentors.length + props.totalDocs}
...
export default AssignedMentorToMunicipalityMentorsData;