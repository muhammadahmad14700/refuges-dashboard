...
function AssignedSupplierToMunicipalitySuppliersData(props) {
  ...
  const continueClick = () => {
    ...
    history.push({
      pathname: "/editAssignRefugeeToMunicipality"
    });
  };
  const cancelClick = () => {
    history.push({
...
export default AssignedSupplierToMunicipalitySuppliersData;