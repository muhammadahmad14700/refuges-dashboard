...
function ViewEditMentorSummary(props) {
  ...
  const handleClickEdit = (path) => {
    ...
    sessionStorage.setItem("alreadyAssignedMunicipality", mentorSummary.getMentorSummary.municipality ? mentorSummary.getMentorSummary.municipality._id : "");
                ...
                >
                  ...
                  <tr>
                    ...
                    <td
                      ...
                      onClick={() => handleClickEdit("/editAssignMunicipalityToMentor")}
                    >
                      {t("View and Edit")}</td>
                  </tr>
                  <tr>
                    ...
                    <td className="summary-table-tag-action-td"
                      onClick={() => handleClickEdit("/editAssignRefugeeToMentor")}
                    >{t("View and Edit")}</td>
                  </tr>
                </table>
