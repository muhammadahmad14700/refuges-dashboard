...
function ViewEditSupplierSummary(props) {
  ...
  const handleClickEdit = (path) => {
    ...
    sessionStorage.setItem("alreadyAssignedMunicipality", supplierSummary.getSupplierSummary.municipality ? supplierSummary.getSupplierSummary.municipality._id : "");
                ...
                >
                  ...
                  <tr>
                    ...
                    <td
                      ...
                      onClick={() => handleClickEdit("/editAssignMunicipalityToSupplier")}
                    >
                      {t("View and Edit")}</td>
                  </tr>
                  <tr>
                    ...
                    <td className="summary-table-tag-action-td"
                      onClick={() => handleClickEdit("/editAssignRefugeeToSupplier")}
                    >{t("View and Edit")}</td>
                  </tr>
                </table>
