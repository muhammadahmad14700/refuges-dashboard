...
function AssignRefugeeToMentor(props) {
  ...
  const assignedRefugees = useSelector(
    ({ AssignRefugeeToMentorReducer }) =>
      AssignRefugeeToMentorReducer.AllAssignedRefugeesReducer.data
  );
  const loading = useSelector(
    ({ AssignRefugeeToMentorReducer }) =>
      AssignRefugeeToMentorReducer.AllAssignedRefugeesReducer.isLoading
  );

  const errMsg = useSelector(
    ({ AssignRefugeeToMentorReducer }) =>
      AssignRefugeeToMentorReducer.AllAssignedRefugeesReducer.errMsg
  );
  React.useEffect(() => {
  ...
  React.useEffect(() => {
    if (add_confirmation.data && add_confirmation.data.data && add_confirmation.data.data.assignUnassignRolesToMentor) {
      ...
      // sessionStorage.removeItem("unAssignedMuniciaplities");
