...
function ViewEditRefugeeSummary(props) {
  ...
  const handleClickEdit = (path) => {
    sessionStorage.setItem("alreadyAssignedMunicipality", refugeeSummary.getRefugeeSummary.municipality ? refugeeSummary.getRefugeeSummary.municipality._id : "");
  ...
  React.useEffect(() => {
    if (refugeeSummary && refugeeSummary.getRefugeeSummary) {
      setTotalMentors((selectedMentors.length + refugeeSummary.getRefugeeSummary.totalMentors - unSelectedMentors.length > 1 ? "1" : selectedMentors.length + refugeeSummary.getRefugeeSummary.totalMentors - unSelectedMentors.length));
                ...
                >
                  ...
                  <tr>
                    ...
                    <td
                      ...
                      onClick={() => handleClickEdit("/editAssignMunicipalityToRefugee")}
                    >
                      {t("View and Edit")}</td>
                  </tr>
                  <tr>
                    ...
                    <td className="summary-table-tag-action-td"
                      onClick={() => handleClickEdit("/editAssignMentorToRefugee")}
                    >{t("View and Edit")}</td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td
                      className="summary-table-tag-action-td"
                      onClick={() => handleClickEdit("/editAssignSupplierToRefugee")}
                    >{t("View and Edit")}</td>
                  </tr>
                </table>
