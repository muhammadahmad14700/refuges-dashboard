...
function AssignRefugeeToMunicipality(props) {
  ...
  React.useEffect(() => {
    if (sessionStorage.getItem("assignedRefugees")) {
      setSelectedMentors(JSON.parse(sessionStorage.getItem("assignedRefugees")));
      setEditCheck(true);
    }
  }, [setSelectedMentors]);
  React.useEffect(() => {
  ...
  const assignedRefugees = useSelector(
    ({ AssignRefugeeToMunicipalityReducer }) =>
      AssignRefugeeToMunicipalityReducer.AllAssignedRefugeesReducer.data
  );
  const loading = useSelector(
    ({ AssignRefugeeToMunicipalityReducer }) =>
      AssignRefugeeToMunicipalityReducer.AllAssignedRefugeesReducer.isLoading
  );

  const errMsg = useSelector(
    ({ AssignRefugeeToMunicipalityReducer }) =>
      AssignRefugeeToMunicipalityReducer.AllAssignedRefugeesReducer.errMsg
  );
  React.useEffect(() => {
    if (
      assignedRefugees &&
                ...
                <div className="assign-mentor-to-municipality-left-grid-child-div">
                  <div className="assign-mentor-to-municipality-title-div">
                    ...
                    <p className="assigned-mentors-to-municipality-total-text">
                      {t("Total Assigned Refugees")}: {selectedRefugees.length + totalDocs}
                    </p>
                  </div>
                </div>
