...
function MunicipalityPipPage(props) {
  ...
  React.useEffect(() => {
    if (history.location.state) {
      ...
      dispatch(Actions.getMunicipalitySummary(history.location.state));
  ...
  const municipalitySummary = useSelector(
    ({ MunicipalityPipPageReducer }) =>
      MunicipalityPipPageReducer.getMunicipalitySummaryReducer.data
  );
  ...
  const handleClickPersoonopen = (id) => {
    ...
    sessionStorage.setItem("mun_id", history.location.state);
    history.push({
      pathname: "/createUserByAdmin"
    });
  };
  const handleClickStatusopen = (id) => {
    setStatusopen(true);
  };
  ...
  return (
    <div className="main-con">
      ...
      {statusopen === true && (
        <Statusmodal status={statusopen} methodd={setStatusopen} mid={history.location.state ? history.location.state : ""} />
      )}
      ...
      <Container fixed className={classes.con}>
        <Grid container spacing={2}>
          <Grid item sm={6} xs={12}>
            {municipalitySummary && municipalitySummary.getMunicipalitySummary && municipalitySummary.getMunicipalitySummary.logoUrl && (
        ...
        >
          <Grid item sm={12} xs={12}>
            <div className="voor-div">
              ...
              >
                ...
                <Grid item sm={2} xs={6}>
                  <div
                    onClick={() => handleClickStatusopen("1")}
                    style={{
                      color: "grey",
                      marginTop: "-25px",
                      cursor: "pointer",
          ...
          <Grid item lg={8} md={12} sm={12} xs={12} className={classes.con1}>
            ...
            {municipalitySummary && municipalitySummary.getMunicipalitySummary && municipalitySummary.getMunicipalitySummary.name && (
