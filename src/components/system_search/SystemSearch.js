...
import MunicipalitiesData from "./sub_components/MunicipalitiesData";
import ManagersData from "./sub_components/ManagersData";
...
function SystemSearch(props) {
  ...
  const handleChangeRole = (role) => {
    if (role.id === "all") {
      if (selectedTab.id === "municipalities") {
        setSearchPlaceholder(t('Search by land, name or contact person'))
      }
      else if (selectedTab.id === "managers") {
        setSearchPlaceholder(t('Search by name or e-mail'))
      }
      else if (selectedTab.id === "suppliers") {
        setSearchPlaceholder(t('Search by name or e-mail'))
      }
      else {
        setSearchPlaceholder(t('Search by name, e-mail or BSN number'))
      ...
      if (role.id === "municipalities") {
        setSearchPlaceholder(t('Search by land, name or contact person'))
      }
      else if (role.id === "managers") {
        setSearchPlaceholder(t('Search by name or e-mail'))
      }
      else if (role.id === "suppliers") {
        setSearchPlaceholder(t('Search by name or e-mail'))
      }
      else {
        setSearchPlaceholder(t('Search by name, e-mail or BSN number'))
  ...
  const handleChangeTab = (tab) => {
    if (tab.id === "municipalities") {
      setSearchPlaceholder(t('Search by land, name or contact person'))
    }
    else if (tab.id === "managers") {
      setSearchPlaceholder(t('Search by name or e-mail'))
    }
      ...
      <div className={bg}>
        <Container fixed>
          <div className="system-search-main-div">
            ...
            {selectedTab.id === "municipalities" && selectedRole.id === "all" && (
              <MunicipalitiesData searchText={searchText} />
            )}
            {selectedTab.id === "managers" && selectedRole.id === "all" && (
