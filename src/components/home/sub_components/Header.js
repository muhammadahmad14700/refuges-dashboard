...
function Header(props) {
  ...
  const navItems = [
    ...
    },
    {
      ...
      items: [
        {
          id: "all_system_users_municipalities",
  ...
  const handleNavigate = (path, id = '') => {
    ...
    else if (id === "all_system_users_managers") {
      history.push(`${path}/?entity=managers`)
    ...
    else if (id === "all_system_users_municipalities") {
      history.push(`${path}/?entity=municipalities`)
