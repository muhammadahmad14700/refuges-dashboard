...
function Profile(props) {
  ...
  React.useEffect(() => {
    if (profile_data && profile_data.getSupplierProfile && profile_data.getSupplierProfile.profileImageUrl) {
      setImagePreviewUrl(profile_data.getSupplierProfile.profileImageUrl);
    }
  }, [profile_data]);
  ...
  const {
    ...
    initialValues: {
      first_name: (profile_data && profile_data.getSupplierProfile && profile_data.getSupplierProfile.name) ? profile_data.getSupplierProfile.name : "",
      last_name: (profile_data && profile_data.getSupplierProfile && profile_data.getSupplierProfile.lastName) ? profile_data.getSupplierProfile.lastName : "",
      phone_no: (profile_data && profile_data.getSupplierProfile && profile_data.getSupplierProfile.phoneNumber) ? profile_data.getSupplierProfile.phoneNumber : "",
      email: (profile_data && profile_data.getSupplierProfile && profile_data.getSupplierProfile.email) ? profile_data.getSupplierProfile.email : "",
      profile_image: ""
    },
    validationSchema,
