            ...
            {mentorSummary && mentorSummary.getMentorSummary && (
              <Grid container spacing={2}>
                ...
                <Grid item xs={4}>
                  ...
                  <p className="edit-municipality-detail-view-data"><span className="edit-municipality-detail-view-label">Name: </span> <span className="edit-municipality-detail-view-text">{mentorSummary && mentorSummary.getMentorSummary.name}</span></p>
                  <p className="edit-municipality-detail-view-data"><span className="edit-municipality-detail-view-label">BSN: </span> <span className="edit-municipality-detail-view-text">{mentorSummary && mentorSummary.getMentorSummary.bsn}</span></p>

                </Grid>
                <Grid item xs={4}>
                  <p className="edit-municipality-detail-view-data"><span className="edit-municipality-detail-view-label">E-mail </span> <span className="edit-municipality-detail-view-text">{mentorSummary && mentorSummary.getMentorSummary.email}</span></p>

                  <p className="edit-municipality-detail-view-data"><span className="edit-municipality-detail-view-label">Phone: </span> <span className="edit-municipality-detail-view-text">{mentorSummary && mentorSummary.getMentorSummary.phoneNumber}</span></p>
                </Grid>
              </Grid>
            )}
            <Grid container spacing={2}>
