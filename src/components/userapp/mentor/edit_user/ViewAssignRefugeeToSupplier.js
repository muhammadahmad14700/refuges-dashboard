...
import RefugeesData from "./sub_components/ViewAssignedRefugeeToMentorRefugeesData";
...
function ViewAssignRefugeeToSupplier(props) {
  ...
  const assignedRefugees = useSelector(
    ({ ViewAssignRefugeeToSupplierReducer }) =>
      ViewAssignRefugeeToSupplierReducer.AllAssignedRefugeesReducer.data
  );
  const loading = useSelector(
    ({ ViewAssignRefugeeToSupplierReducer }) =>
      ViewAssignRefugeeToSupplierReducer.AllAssignedRefugeesReducer.isLoading
  );

  const errMsg = useSelector(
    ({ ViewAssignRefugeeToSupplierReducer }) =>
      ViewAssignRefugeeToSupplierReducer.AllAssignedRefugeesReducer.errMsg
  );
            ...
            <Grid item sm={12} xs={12}>
              <div className="assign-mentor-to-municipality-left-grid-div">
                ...
                <RefugeesData
                  ...
                  assignedRefugees={assignedRefugees}
...
export default withReducer("ViewAssignRefugeeToSupplierReducer", reducer)(ViewAssignRefugeeToSupplier);