...
function Profile(props) {
  ...
  React.useEffect(() => {
    if (profile_data && profile_data.getMentorProfile && profile_data.getMentorProfile.profileImageUrl) {
      setImagePreviewUrl(profile_data.getMentorProfile.profileImageUrl);
    }
  }, [profile_data]);
  ...
  const {
    ...
    initialValues: {
      first_name: (profile_data && profile_data.getMentorProfile && profile_data.getMentorProfile.name) ? profile_data.getMentorProfile.name : "",
      last_name: (profile_data && profile_data.getMentorProfile && profile_data.getMentorProfile.lastName) ? profile_data.getMentorProfile.lastName : "",
      phone_no: (profile_data && profile_data.getMentorProfile && profile_data.getMentorProfile.phoneNumber) ? profile_data.getMentorProfile.phoneNumber : "",
      email: (profile_data && profile_data.getMentorProfile && profile_data.getMentorProfile.email) ? profile_data.getMentorProfile.email : "",
      profile_image: ""
    },
    validationSchema,
