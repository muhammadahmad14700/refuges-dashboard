        ...
        if (
          ...
          if (err.graphQLErrors && err.graphQLErrors.length > 0) {
            if (err.graphQLErrors[0].extensions && err.graphQLErrors[0].extensions.code && err.graphQLErrors[0].extensions.code === 400 && err.graphQLErrors[0].extensions.errors && err.graphQLErrors[0].extensions.errors.length > 0) {
              ...
              dispatch(
                editEventFailed(JSON.stringify(err.graphQLErrors[0].message))
              );
            }
          } else {
            dispatch(editEventFailed("Something went wrong"));
          }
        }
      });
  };
      ...
      .catch((err) => {
        if (
          ...
          if (err.graphQLErrors && err.graphQLErrors.length > 0) {
            ...
            dispatch(deleteEventFailed("Something went wrong"));
          }
        }
      });
  };
    ...
    client
      ...
      .catch((err) => {
        if (err.graphQLErrors && err.graphQLErrors[0].length > 0) {
          ...
          dispatch(addNewExtraAttributeFailed("Something went wrong"))
        }
      });
  };
}
  ...
  return (dispatch) => {
    ...
    client
      .mutate({
        mutation: gql`
        mutation {
          updateExtraAttribute ( input: {
            refugeeId:"${id}",
            oldExtraAttribute:"${values.old_extra_attribute}",
            extraAttribute:"${values.extra_attribute}"
          })
            {
              extraAttributes
            }
      ...
      .catch((err) => {
        if (err.graphQLErrors && err.graphQLErrors[0].length > 0) {
          ...
          dispatch(updateExtraAttributeFailed("Something went wrong"));
        }
      });
  };
}
    ...
    client
      ...
      .catch((err) => {
        if (err.graphQLErrors && err.graphQLErrors[0].length > 0) {
          ...
          dispatch(deleteExtraAttributeFailed("Something went wrong"));
        }
      });
  };
}
    ...
    client
      ...
      .catch((err) => {
        if (err.graphQLErrors && err.graphQLErrors[0].length > 0) {
          ...
          dispatch(
            deleteRemarkFailed(JSON.stringify(err.graphQLErrors[0].message))
          );
        }
        else {
          dispatch(deleteRemarkFailed("Something went wrong"));
        }
      });
  };
}
...
export function getAllUnAssignedRefuges(page, limit) {
  return (dispatch) => {
...
export function getAllAssignedRefuges(page, limit, mid = jwt.decode(localStorage.jwtToken).id) {
  return (dispatch) => {
    ...
    client
      .query({
        query: gql`
        {
          listAllRefugees(page: ${parseInt(page)}, limit: ${parseInt(limit)}, filter:{mentorId: "${mid}"}){
            totalDocs
            limit
            page
            totalPages
      ...
      .catch((err) => {
        if (
          ...
          if (err.graphQLErrors && err.graphQLErrors.length > 0) {
            ...
            dispatch(AllRefugesFailed("Something went wrong"))
      ...
      .catch((err) => {
        if (
          ...
          if (err.graphQLErrors && err.graphQLErrors.length > 0) {
            ...
            dispatch(AllNotificationsFailed("Something went wrong"))
          }
        }
      });
  };
        ...
        if (
          ...
          if (err.graphQLErrors && err.graphQLErrors.length > 0) {
            if (err.graphQLErrors[0].extensions && err.graphQLErrors[0].extensions.code && err.graphQLErrors[0].extensions.code === 400 && err.graphQLErrors[0].extensions.errors && err.graphQLErrors[0].extensions.errors.length > 0) {
              ...
              dispatch(
                addNewPipFailed(JSON.stringify(err.graphQLErrors[0].message))
              );
            }
          } else {

            dispatch(addNewPipFailed("Something went wrong"));
          }
        }
      });
    // }, 1500);
      ...
      .catch((err) => {
        if (
          ...
          if (err.graphQLErrors && err.graphQLErrors.length > 0) {
            ...
            dispatch(BredeintakeFailed("Something went wrong"));
          }
        }
      });
  };
      ...
      .catch((err) => {
        if (
          ...
          if (err.graphQLErrors && err.graphQLErrors.length) {
            ...
            dispatch(pipprogressStatsFailed("Something went wrong"));
          }
        }
      });
  };
...
export function getExtraattributes(id) {
  // alert("dispatched getExtraattributes")
  return (dispatch) => {
