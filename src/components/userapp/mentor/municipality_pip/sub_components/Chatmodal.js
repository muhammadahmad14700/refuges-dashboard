...
export default function Chatmodal(props) {
  ...
  function join() {
    socket.current.emit('join', {
      receiverId: (valueState === 0 && props.data.id) ? props.data.id : (valueState === 1 && props.data.municipality && props.data.municipality.manager) ? props.data.municipality.manager._id : (valueState === 2 && props.data.suppliers && props.data.suppliers.work) ? props.data.suppliers.work._id : (valueState === 3 && props.data.suppliers && props.data.suppliers.school) ? props.data.suppliers.school._id : "",
    }, (res) => {
        ...
        >
          <div className="chat-div">
            <AppBar position="static" className={classes.head}>
              <Tabs TabIndicatorProps={{
                ...
                <Tab
                  ...
                  label={<span className={classes.tabLabel}>{t("Refugee")}</span>} {...a11yProps(0)} />
                <Tab
                  className={value === 1 ? classes.active_tabStyle : classes.default_tabStyle}
                  label={<span className={classes.tabLabel}>{t("Manager")}</span>} {...a11yProps(1)} />
                <Tab
                  className={value === 2 ? classes.active_tabStyle : classes.default_tabStyle}
                  label={<span className={classes.tabLabel}>{t("Work Supplier")}</span>} {...a11yProps(2)} />
                <Tab
                  className={value === 3 ? classes.active_tabStyle : classes.default_tabStyle}
                  label={<span className={classes.tabLabel}>{t("School Supplier")}</span>} {...a11yProps(3)} />
              </Tabs>
            </AppBar>
                  ...
                  <div id="scrollableDiv" ref={paneDidMount} className="msg-wrapper">
                    {
                      ...
                      messages.map((msg) => (
                        ...
                        (msg.type === "text") ? (<div className={(msg.senderId === jwt.decode(localStorage.jwtToken).id) ? "chat-receiver sb12" : "chat-sender sb11"}>
                          <h5 className="msg-head">{(msg.senderId === jwt.decode(localStorage.jwtToken).id) ? props.data.mentor.name : props.data.name} {(new Date(msg.sentTime)).toLocaleString()}</h5>
            ...
            <TabPanel value={value} index={1}>
                  ...
                  <div id="scrollableDiv" ref={paneDidMount} className="msg-wrapper">
                    {
                      ...
                      messages.map((msg) => (
                        ...
                        (msg.type === "text") ? (<div className={(msg.senderId === jwt.decode(localStorage.jwtToken).id) ? "chat-receiver sb12" : "chat-sender sb11"}>
                          <h5 className="msg-head">{(msg.senderId === jwt.decode(localStorage.jwtToken).id) ? props.data.mentor.name : props.data.municipality.manager.name} {(new Date(msg.sentTime)).toLocaleString()}</h5>
                          <p className="msg-text">{msg.body}</p>
                          <div className={(msg.senderId === jwt.decode(localStorage.jwtToken).id && msg.status === "seen") ? "seen-msg-div" : "seen-msg-div-none"}>
                            <span style={{ margin: "3px", float: "right", fontSize: "12px" }}>{(new Date(msg.sentTime)).toLocaleString()}</span>
                            <DoneAllIcon style={{ color: "#3f51b5", margin: 0, float: "right" }} />
              ...
              {(!props.data.municipality || !props.data.municipality.manager) && (
                <div style={{ padding: "100px" }}>{t("Manager is not assign to this refugee")}</div>
              )}
            </TabPanel>
                  ...
                  <div id="scrollableDiv" ref={paneDidMount} className="msg-wrapper">
                    {
                      ...
                      messages.map((msg) => (
                        ...
                        (msg.type === "text") ? (<div className={(msg.senderId === jwt.decode(localStorage.jwtToken).id) ? "chat-receiver sb12" : "chat-sender sb11"}>
                          <h5 className="msg-head">{(msg.senderId === jwt.decode(localStorage.jwtToken).id) ? props.data.mentor.name : props.data.suppliers.work.name} {(new Date(msg.sentTime)).toLocaleString()}</h5>
                          <p className="msg-text">{msg.body}</p>
                          <div className={(msg.senderId === jwt.decode(localStorage.jwtToken).id && msg.status === "seen") ? "seen-msg-div" : "seen-msg-div-none"}>
                            <span style={{ margin: "3px", float: "right", fontSize: "12px" }}>{(new Date(msg.sentTime)).toLocaleString()}</span>
                            <DoneAllIcon style={{ color: "#3f51b5", margin: 0, float: "right" }} />
                  ...
                  <div id="scrollableDiv" ref={paneDidMount} className="msg-wrapper">
                    {
                      ...
                      messages.map((msg) => (
                        ...
                        (msg.type === "text") ? (<div className={(msg.senderId === jwt.decode(localStorage.jwtToken).id) ? "chat-receiver sb12" : "chat-sender sb11"}>
                          <h5 className="msg-head">{(msg.senderId === jwt.decode(localStorage.jwtToken).id) ? props.data.mentor.name : props.data.suppliers.school.name} {(new Date(msg.sentTime)).toLocaleString()}</h5>
                          <p className="msg-text">{msg.body}</p>
                          <div className={(msg.senderId === jwt.decode(localStorage.jwtToken).id && msg.status === "seen") ? "seen-msg-div" : "seen-msg-div-none"}>
                            <span style={{ margin: "3px", float: "right", fontSize: "12px" }}>{(new Date(msg.sentTime)).toLocaleString()}</span>
                            <DoneAllIcon style={{ color: "#3f51b5", margin: 0, float: "right" }} />
