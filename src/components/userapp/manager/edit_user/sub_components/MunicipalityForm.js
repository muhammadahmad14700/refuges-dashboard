...
function MunicipalityForm(props) {
  ...
  const validationSchema = yup.object({
    province: yup.string().required("Province is required").max(20, "Province must be at most 20 characters"),
    municipality_name: yup.string().required("Municipality Name is required").max(20, "Municipality Name must be at most 20 characters"),
    manager_name: yup.string().required("Manager Name is required").matches(/^[A-Za-z ]*$/, 'Please enter valid name')
      .max(20, "Manager Name must be at most 20 characters"),
    manager_phone_no: yup.string().required("Manager Phone Number is required").matches(phoneRegExp, 'Phone Number is not valid').min(10, "to short")
      .max(15, "to long"),
    manager_email: yup.string().email().required("Email is Required").max(30, "Email must be at most 30 characters"),
    logo: yup
      .mixed()
      .test(
        "fileSize",
    ...
    <div>
      <form onSubmit={handleSubmit}>
        <Grid container spacing={2} className={classes.con}>
          <Grid item sm={2} xs={4}>
            <p className="create-user-label-text">Land</p>
          </Grid>
          ...
          <Grid item sm={2} xs={4}>
            <p className="create-user-label-text">Municipality Name</p>
          </Grid>
          <Grid item sm={10} xs={8}>
            <TextField
              ...
              variant="outlined"
              size="small"
              placeholder="Enter Municipality’s Full Name"
          ...
          <Grid item sm={2} xs={4} className={classes.munGrid}>
            <p className="create-user-label-text">Manager Name</p>
          </Grid>
          ...
          <Grid item sm={2} xs={4}>
            <p className="create-user-label-text">Email</p>
          </Grid>
          <Grid item sm={10} xs={8}>
            <TextField
              id="manager_email"
              ...
              variant="outlined"
              size="small"
              placeholder="Enter Municipality’s Email"
          ...
          <Grid item sm={2} xs={4}>
            <p className="create-user-label-text">Telephone</p>
          </Grid>
          <Grid item sm={10} xs={8}>
            <TextField
              id="manager_phone_no"
              ...
              variant="outlined"
              size="small"
              placeholder="Enter Municipality’s Phone"
              error={(errors.manager_phone_no && touched.manager_phone_no) ? true : false}
            />
        ...
        <Grid container spacing={2} className={classes.con}>
          <Grid item sm={2} xs={4}>
            <p className="create-user-label-text">Contact Person</p>
          </Grid>
          <Grid item sm={10} xs={8}>
            <TextField
          ...
          <Grid item sm={2} xs={4}>
            <p className="create-user-label-text">POI (DISK) Link</p>
          </Grid>
          <Grid item sm={10} xs={8}>
            <TextField
              id="poi_url"
          ...
          <Grid item sm={2} xs={4}>
            <p className="create-user-label-text">Upload Logo</p>
          </Grid>
          <Grid item sm={3} xs={4}>
            <input
              accept="image/*"
        ...
        <div className="create-user-part2-div">
          <p className="create-user-part-text">Part 2</p>
        </div>
        ...
        >
          <div className="create-user-assign-user-text-div">
            <p className="create-user-assign-user-text">
              Assign Mentors/Suppliers/Refugees
              </p>
