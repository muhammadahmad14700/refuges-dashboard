...
export function getAllAssignedMunicipalities(page, limit, filterByName = '', managerId = jwt.decode(localStorage.jwtToken).id) {
  return (dispatch) => {
...
export function getAllMunicipalities(page, limit, filterByName = '', managerId = jwt.decode(localStorage.jwtToken).id) {
  return (dispatch) => {
