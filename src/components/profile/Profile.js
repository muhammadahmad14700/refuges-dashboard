...
function Profile(props) {
  ...
  React.useEffect(() => {
    if (update_confirmation.data && update_confirmation.data.data && update_confirmation.data.data.updateAdminProfile) {
      dispatch(Actions.resetupdateProfile(true));
  ...
  React.useEffect(() => {
    if (profile_data && profile_data.getAdminProfile && profile_data.getAdminProfile.profileImageUrl) {
      setImagePreviewUrl(profile_data.getAdminProfile.profileImageUrl);
    }
  }, [profile_data]);
  ...
  const {
    ...
    initialValues: {
      first_name: (profile_data && profile_data.getAdminProfile && profile_data.getAdminProfile.name) ? profile_data.getAdminProfile.name : "",
      last_name: (profile_data && profile_data.getAdminProfile && profile_data.getAdminProfile.lastName) ? profile_data.getAdminProfile.lastName : "",
      phone_no: (profile_data && profile_data.getAdminProfile && profile_data.getAdminProfile.phoneNumber) ? profile_data.getAdminProfile.phoneNumber : "",
      email: (profile_data && profile_data.getAdminProfile && profile_data.getAdminProfile.email) ? profile_data.getAdminProfile.email : "",
      profile_image: ""
    },
    validationSchema,
