      ...
      .catch((err) => {
        if (
          ...
          if (err.graphQLErrors && err.graphQLErrors.length > 0) {
            ...
            dispatch(
              assignUnassignRolesToMunicipalityFailed("Something went wrong")
            );
          }
        }
      });
      ...
      .catch((err) => {
        if (
          ...
          if (err.graphQLErrors && err.graphQLErrors.length > 0) {
            ...
            dispatch(
              assignUnassignRolesToRefugeeFailed(err.graphQLErrors[0].message));
          } else {
      ...
      .catch((err) => {
        if (
          ...
          if (err.graphQLErrors && err.graphQLErrors.length > 0) {
            ...
            dispatch(
              assignUnassignRolesToMentorFailed(err.graphQLErrors[0].message)
            );
          } else {
      ...
      .catch((err) => {
        if (
          ...
          if (err.graphQLErrors && err.graphQLErrors.length > 0) {
            ...
            dispatch(
              assignUnassignRolesToSupplierFailed(err.graphQLErrors[0].message));
          } else {
      ...
      .catch((err) => {
        if (err.networkError && err.networkError.result && err.networkError.result.errors && err.networkError.result.errors.length && err.networkError.result.errors[0] && err.networkError.result.errors[0].extensions && err.networkError.result.errors[0].extensions.code && err.networkError.result.errors[0].extensions.code === 401) {
          ...
          if (err.graphQLErrors && err.graphQLErrors.length > 0) {
            ...
            dispatch(
              refugeeSummaryFailed(err.graphQLErrors[0].message));
          }
          else {
            dispatch(
