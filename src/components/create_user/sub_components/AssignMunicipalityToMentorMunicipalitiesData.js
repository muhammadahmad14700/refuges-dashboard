...
function AssignMunicipalityToMentorMunicipalitiesData(props) {
  ...
  const SearchedMunicipalities = useSelector(
    ({ AssignMunicipalityToMentorMunicipalitiesDataReducer }) =>
      AssignMunicipalityToMentorMunicipalitiesDataReducer.allMiniSearchedMunicipalitiesReducer.data
  );
  const loading = useSelector(
    ({ AssignMunicipalityToMentorMunicipalitiesDataReducer }) =>
      AssignMunicipalityToMentorMunicipalitiesDataReducer.allMiniSearchedMunicipalitiesReducer.isLoading
  );

  const errMsg = useSelector(
    ({ AssignMunicipalityToMentorMunicipalitiesDataReducer }) =>
      AssignMunicipalityToMentorMunicipalitiesDataReducer.allMiniSearchedMunicipalitiesReducer.errMsg
  );
  React.useEffect(() => {
    timer.current = window.setTimeout(() => {
      if (SearchedMunicipalities && SearchedMunicipalities.miniSearchAllMunicipalities && props.selectedMunicipalities.length === 0) {
...
export default withReducer("AssignMunicipalityToMentorMunicipalitiesDataReducer", reducer)(AssignMunicipalityToMentorMunicipalitiesData);