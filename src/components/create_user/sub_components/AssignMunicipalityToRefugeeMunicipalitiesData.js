...
function AssignMunicipalityToRefugeeMunicipalitiesData(props) {
  ...
  const SearchedMunicipalities = useSelector(
    ({ AssignMunicipalityToRefugeeMunicipalitiesDataReducer }) =>
      AssignMunicipalityToRefugeeMunicipalitiesDataReducer.allMiniSearchedMunicipalitiesReducer.data
  );
  const loading = useSelector(
    ({ AssignMunicipalityToRefugeeMunicipalitiesDataReducer }) =>
      AssignMunicipalityToRefugeeMunicipalitiesDataReducer.allMiniSearchedMunicipalitiesReducer.isLoading
  );

  const errMsg = useSelector(
    ({ AssignMunicipalityToRefugeeMunicipalitiesDataReducer }) =>
      AssignMunicipalityToRefugeeMunicipalitiesDataReducer.allMiniSearchedMunicipalitiesReducer.errMsg
  );
  React.useEffect(() => {
...
export default withReducer("AssignMunicipalityToRefugeeMunicipalitiesDataReducer", reducer)(AssignMunicipalityToRefugeeMunicipalitiesData);