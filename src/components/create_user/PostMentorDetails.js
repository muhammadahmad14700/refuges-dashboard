...
function PostMentorDetails(props) {
  ...
  const add_confirmation = useSelector(
    ({ PostMentorDetailsReducer }) => PostMentorDetailsReducer.assignUnassignRolesToMentorReducer
  );
  React.useEffect(() => {
  ...
  const mentorSummary = useSelector(
    ({ PostMentorDetailsReducer }) =>
      PostMentorDetailsReducer.getMentorSummaryReducer.data
  );
  const loading = useSelector(
    ({ PostMentorDetailsReducer }) =>
      PostMentorDetailsReducer.getMentorSummaryReducer.isLoading
  );
  const errMsg = useSelector(
    ({ PostMentorDetailsReducer }) =>
      PostMentorDetailsReducer.getMentorSummaryReducer.errMsg
  );
  React.useEffect(() => {
                ...
                >
                  ...
                  <tr>
                    ...
                    <td
                      ...
                      onClick={() => handleClickEdit("/assignMunicipalityToMentor")}
                    >
                      {t("View and Edit")}</td>
                  </tr>
                  <tr>
                    ...
                    <td className="summary-table-tag-action-td"
                      onClick={() => handleClickEdit("/assignRefugeeToMentor")}
                    >{t("View and Edit")}</td>
                  </tr>
                </table>
...
export default withReducer("PostMentorDetailsReducer", reducer)(PostMentorDetails);