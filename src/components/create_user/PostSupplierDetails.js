...
function PostSupplierDetails(props) {
  ...
  const loading = useSelector(
    ({ PostSupplierDetailsReducer }) =>
      PostSupplierDetailsReducer.getSupplierSummaryReducer.isLoading
  );
  const errMsg = useSelector(
    ({ PostSupplierDetailsReducer }) =>
      PostSupplierDetailsReducer.getSupplierSummaryReducer.errMsg
  );
  React.useEffect(() => {
                ...
                >
                  ...
                  <tr>
                    ...
                    <td
                      ...
                      onClick={() => handleClickEdit("/assignMunicipalityToSupplier")}
                    >
                      {t("View and Edit")}</td>
                  </tr>
                  <tr>
                    ...
                    <td className="summary-table-tag-action-td"
                      onClick={() => handleClickEdit("/assignRefugeeToSupplier")}
                    >{t("View and Edit")}</td>
                  </tr>
                </table>
