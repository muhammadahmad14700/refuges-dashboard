...
import MunicipalityForm from "./sub_components/MunicipalityForm";
...
function CreateUser(props) {
    ...
    const [selectedUserType, setSelectedUserType] = React.useState("municipality");
    ...
    const createUserSteps = useSelector(
        ({ CreateUserReducer }) =>
            CreateUserReducer.setCreateUserStepsReducer.steps
    );
    const handleSetSteps = (step) => {
        let steps = createUserSteps;
        steps.push(step);
        localStorage.setItem("steps", steps);
        dispatch(Actions.setCreateUserSteps(steps));
    };
...
export default withReducer("CreateUserReducer", reducer)(CreateUser);