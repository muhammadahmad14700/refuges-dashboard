...
function UpdatePassword(props) {
  ...
  const {
    ...
    initialValues: {
      email: jwt.decode(localStorage.jwtToken).email ? jwt.decode(localStorage.jwtToken).email : "admin@gmail.com",
      password: "",
      confirm_password: "",
      old_password: ""
    },
  ...
  React.useEffect(() => {
    if (update_confirmation.data && update_confirmation.data.data && update_confirmation.data.data.updateAdminPassword) {
      resetForm();
